  ...
  return (
    <section id="impact" className="impact-section" style={{ 
      ...
      <div className="container" style={{ textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '3rem', color: 'var(--color-navy)', marginTop: '0.5rem', marginBottom: '1.5rem', letterSpacing: '-1px' }} className="impact-title">
          {language === 'tr' ? 'Küçük gelişmeler,' : 'Small improvements,'}<br/>{language === 'tr' ? 'büyük gelir etkisi.' : 'large revenue impact.'}
        </h2>
        <p style={{ fontSize: '1.25rem', color: 'var(--color-gray)', maxWidth: '750px', margin: '0 auto 4rem', lineHeight: 1.6 }} className="impact-desc">
          {language === 'tr' 
        ...
        {/* Impact Numbers */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap', marginBottom: '6rem' }} className="impact-grid">
          <div className="card-hover impact-stat-card" style={{ padding: '3rem', border: '1px solid var(--color-gray-light)', borderRadius: '16px', minWidth: '300px', backgroundColor: '#fafafa' }}>
          ...
          <div className="card-hover impact-stat-card highlight" style={{ padding: '3rem', border: `2px solid var(--color-orange)`, borderRadius: '16px', minWidth: '300px', backgroundColor: 'var(--color-white)', position: 'relative', boxShadow: '0 20px 40px rgba(243, 159, 28, 0.1)' }}>
            <div className="impact-badge" style={{ position: 'absolute', top: '-20px', right: '-20px', backgroundColor: 'var(--color-green)', color: 'white', padding: '0.75rem', borderRadius: '50%', boxShadow: '0 8px 16px rgba(40, 163, 189, 0.3)' }}>
        ...
        <div className="case-study-card" style={{ 
          ...
          <div style={{ position: 'absolute', right: '-50px', bottom: '-100px', opacity: 0.1 }} className="case-study-bg">
            <Award size={500} color="var(--color-orange)" />
          </div>

          <div style={{ flex: '1 1 400px', zIndex: 1 }} className="case-study-content">
            <div style={{ backgroundColor: 'rgba(243, 159, 28, 0.2)', color: 'var(--color-orange)', display: 'inline-block', padding: '0.6rem 1.25rem', borderRadius: '100px', marginBottom: '2.5rem', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', border: '1px solid rgba(243, 159, 28, 0.3)' }} className="case-study-badge">
              {language === 'tr' ? 'Vaka Çalışması' : 'Case Study'}
            </div>
            
            <div style={{ marginBottom: '2.5rem', display: 'flex', alignItems: 'center' }} className="case-study-logo-area">
            ...
            <p style={{ fontSize: '1.35rem', opacity: 0.95, lineHeight: 1.6, marginBottom: '3rem', textShadow: '0 2px 4px rgba(0,0,0,0.3)' }} className="case-study-desc">
              {language === 'tr' 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem' }} className="case-study-stats">
              <div style={{ backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.15)', padding: '1.75rem', borderRadius: '16px', backdropFilter: 'blur(10px)', transition: 'transform 0.3s' }} className="card-hover stat-box">
          ...
          <div style={{ flex: '1 1 300px', zIndex: 1, display: 'flex', justifyContent: 'center' }} className="case-study-cta-area">
            <div style={{ textAlign: 'center', backgroundColor: 'rgba(255,255,255,0.08)', padding: '4rem 3rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.2)', backdropFilter: 'blur(20px)', boxShadow: '0 30px 60px rgba(0,0,0,0.3)' }} className="cta-box">
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          @media (max-width: 768px) {
            ...
            .impact-title { font-size: 2rem !important; }
            .impact-desc { font-size: 1.1rem !important; margin-bottom: 2rem !important; }
            .impact-grid { gap: 1rem !important; margin-bottom: 4rem !important; }
            .impact-stat-card { flex: 1 1 100% !important; min-width: 100% !important; padding: 2rem !important; }
            .impact-stat-card h3 { font-size: 2.25rem !important; }
            .case-study-card { padding: 3rem 1.5rem !important; gap: 3rem !important; }
            .case-study-content { flex: 1 1 100% !important; }
            .case-study-desc { font-size: 1.15rem !important; margin-bottom: 2rem !important; }
            .case-study-badge { margin-bottom: 1.5rem !important; }
            .case-study-logo-area { margin-bottom: 1.5rem !important; }
            .case-study-bg { display: none !important; }
            .case-study-cta-area { flex: 1 1 100% !important; }
            .cta-box { padding: 2.5rem 1.5rem !important; width: 100% !important; }
            .cta-box p { font-size: 1.25rem !important; margin-bottom: 1.5rem !important; }
          }
        `}} />
      </div>
    </section>
