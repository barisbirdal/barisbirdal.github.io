...
const Impact = () => {
  ...
  return (
    <section id="impact" className="impact-section" style={{ 
      padding: '8rem 0', 
      background: 'linear-gradient(rgba(244, 246, 249, 0.95), rgba(255, 255, 255, 0.95)), url("https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1920&q=80")',
      ...
      <div className="container" style={{ textAlign: 'center' }}>
        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative', marginBottom: '6rem', zIndex: 2, height: '80px', padding: '0 40px' }} className="impact-chart-headers">
            ...
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
              ...
              <div style={{ 
                position: 'absolute', left: '50%', top: 0, bottom: 0, right: 0, 
              ...
              {/* Left Icon and Text */}
              <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '50%', display: 'flex', alignItems: 'center', zIndex: 3 }}>
                <div style={{ position: 'absolute', left: '-20px', background: 'white', border: '6px solid #5a6577', borderRadius: '50%', width: '100px', height: '100px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
                  <Settings size={42} color="#374151" />
                </div>
                <div style={{ width: '100%', textAlign: 'center', paddingLeft: '40px' }}>
                  <span style={{ fontSize: '1.4rem', fontWeight: 600, color: 'white' }}>
              ...
              {/* Right Icon and Text */}
              <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '50%', display: 'flex', alignItems: 'center', zIndex: 3 }}>
                <div style={{ width: '100%', textAlign: 'center', paddingRight: '40px' }}>
                  <span style={{ fontSize: '1.4rem', fontWeight: 600, color: 'white' }}>
                    {language === 'tr' ? 'LetsSellApp Sonrası' : 'After LetsSellApp'}
                  </span>
                </div>
                <div style={{ position: 'absolute', right: '-20px', background: 'white', border: '6px solid var(--color-orange)', borderRadius: '50%', width: '100px', height: '100px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 25px rgba(243, 159, 28, 0.3)' }}>
                  <Lightbulb size={42} color="#374151" />
                </div>
              </div>
              ...
              {rows.map((row, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2.5rem', alignItems: 'center' }} className="chart-row">
                  ...
                  <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '1.5rem', paddingRight: '2.5rem' }} className="col-left">
                    <div style={{ width: '56px', height: '56px', borderRadius: '50%', backgroundColor: '#5a6577', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '1.15rem', flexShrink: 0, boxShadow: '0 4px 15px rgba(90, 101, 119, 0.3)', position: 'relative', zIndex: 2 }}>
                      {row.valLeft}
                    </div>
                  ...
                  <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '1.5rem', paddingLeft: '2.5rem' }} className="col-right">
                    ...
                    <div style={{ width: '56px', height: '56px', borderRadius: '50%', backgroundColor: 'var(--color-orange)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '1.15rem', flexShrink: 0, boxShadow: '0 4px 15px rgba(243, 159, 28, 0.5)', position: 'relative', zIndex: 2 }}>
                      {row.valRight}
                    </div>
                  </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '6rem', maxWidth: '800px', margin: '6rem auto 0' }}>
          <div style={{ width: '60px', height: '4px', backgroundColor: 'var(--color-orange)', margin: '0 auto 2rem', borderRadius: '4px' }}></div>
          <p style={{ fontSize: '1.8rem', color: 'var(--color-navy)', fontWeight: 600, lineHeight: 1.5, letterSpacing: '-0.5px' }}>
            {language === 'tr' 
        ...
        <div style={{ marginTop: '6rem' }}>
          <div className="proof-card" style={{ 
            background: 'linear-gradient(135deg, rgba(28, 43, 75, 0.95), rgba(15, 23, 42, 0.98)), url("https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&w=1920&q=80")',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            borderRadius: '24px', 
            padding: '5rem 6rem', 
            ...
            {/* Top Left Badge */}
            <div style={{ position: 'absolute', top: '2.5rem', left: '3rem', backgroundColor: 'rgba(255,255,255,0.08)', color: 'var(--color-orange)', padding: '0.4rem 1.2rem', borderRadius: '100px', fontSize: '0.8rem', fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase', border: '1px solid rgba(255,255,255,0.1)', zIndex: 10 }}>
            ...
            <div style={{ flex: '1 1 350px', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }} className="proof-content">
              ...
              <div style={{ backgroundColor: '#ffffff', padding: '1.5rem 2.5rem', borderRadius: '24px', display: 'inline-flex', marginBottom: '3rem', boxShadow: '0 15px 40px rgba(0,0,0,0.3)' }}>
                <img 
              ...
              <div>
                <h3 style={{ fontSize: '3.2rem', color: 'white', fontWeight: 800, marginBottom: '0.8rem', lineHeight: 1.1, letterSpacing: '-1.5px' }}>
                  {language === 'tr' ? 'Ne Başardı?' : 'What They Achieved?'}
                </h3>
                <p style={{ fontSize: '1.4rem', color: 'var(--color-orange)', fontWeight: 600, opacity: 0.9, letterSpacing: '0.5px' }}>
                  {language === 'tr' ? 'Gerçek Hayat Sonuçları' : 'Real Life Results'}
                </p>
              </div>

              {/* Left Column CTA */}
              <div style={{ marginTop: '4rem', padding: '2rem', backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.08)' }}>
                <p style={{ fontSize: '1.25rem', color: 'white', fontWeight: 600, marginBottom: '1.5rem', lineHeight: 1.4 }}>
                ...
                <button onClick={() => navigate('/contact')} style={{ backgroundColor: 'var(--color-orange)', color: 'white', padding: '1rem 2rem', borderRadius: '12px', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: '0.5rem', border: 'none', cursor: 'pointer', boxShadow: '0 8px 20px rgba(243, 159, 28, 0.3)', transition: 'transform 0.2s', fontSize: '1.1rem' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-2px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
              ...
              {[
                ...
                <div key={idx} style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', marginBottom: '1rem' }}>
                    ...
                    <span style={{ fontSize: '3rem', color: 'var(--color-white)', fontWeight: 800, letterSpacing: '-1px', lineHeight: 1 }}>{stat.val}</span>
                  </div>
                  <div style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.7)', fontWeight: 600, lineHeight: 1.4, maxWidth: '160px' }}>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          @media (max-width: 768px) {
            .impact-section { padding: 4rem 1rem !important; }
            .impact-title { font-size: 2.2rem !important; margin-bottom: 3rem !important; }
            .impact-chart-headers { flex-direction: column !important; gap: 1rem !important; margin-bottom: 2rem !important; height: auto !important; }
            .chart-header-left, .chart-header-right { width: 100% !important; clip-path: none !important; border-radius: 12px !important; margin: 0 !important; padding: 1.5rem !important; min-height: 80px !important; }
            .chart-header-left > div, .chart-header-right > div { position: static !important; width: 60px !important; height: 60px !important; margin: 0 auto 1rem !important; transform: none !important; }
            .chart-header-left span, .chart-header-right span { margin: 0 !important; display: block; text-align: center; }
            .chart-row { flex-direction: column !important; gap: 1.5rem !important; align-items: stretch !important; border-bottom: 1px solid #e5e7eb; padding-bottom: 2rem !important; margin-bottom: 2rem !important; }
            .chart-row:last-child { border-bottom: none; }
            .col-left, .col-right { width: 100% !important; padding: 0 !important; justify-content: flex-start !important; }
            .col-right { flex-direction: row-reverse !important; justify-content: flex-start !important; }
            .col-right span { text-align: left !important; }
            .mobile-hide { display: none !important; }
            .proof-card { padding: 3rem 1.5rem !important; gap: 3rem !important; }
